...
function Sidebar() {
  ...
  useEffect(() => {
    async function fetchUser() {
      try {
        ...
        console.warn(
          "Không tải được thông tin mới nhất, tiếp tục dùng data từ Token.",
          error,
        );
      }
    }
  ...
  const mentorMenuItems = [
    {
      icon: <FaFolderOpen />,
      text: "Duyệt Portfolio",
      path: "/dashboard/mentor",
    },
    {
      icon: <FaClipboardCheck />,
      text: "Lịch sử nhận xét",
  ...
  const renderMenuItem = (item, index) => {
    ...
    if (item.text === "Lịch sử đánh giá") {
      ...
      isItemActive =
        location.pathname.includes("/dashboard/admin/management") ||
  ...
  return (
    <div
      className="d-flex flex-column p-3 text-white flex-shrink-0"
      style={{
        width: "260px",
      ...
      <div className="p-3 mb-4 rounded" style={{ backgroundColor: "#111122" }}>
        <div className="d-flex align-items-center gap-3">
          {user?.avatar ? (
            ...
            <div
              className="rounded-circle bg-secondary d-flex align-items-center justify-content-center fw-bold text-dark"
          ...
          <div>
            <div
              className="fw-semibold small text-white text-truncate"
              style={{ maxWidth: "130px" }}
            >
              {user?.fullName || "Người dùng"}
            </div>
            <div
              className="text-white-50 extra-small text-truncate"
        ...
        {userRole === "student" && (
          <div className="mt-3">
            <div
              className="d-flex align-items-center gap-2 px-2 py-1.5 rounded-3"
              style={{
            ...
            >
              <i
                className="bi bi-compass text-info"
                style={{ fontSize: "13px" }}
              ></i>
