...
function Badges({ badges }) {
  return (
    <div
      ...
      style={{ backgroundColor: "#131520", border: "1px solid #1e2235" }}
    >
      <div
        className="text-white-50 text-uppercase fw-bold mb-3"
      ...
      <div className="row g-3">
        ...
        {badges.map((badge) => (
          <div key={badge.id} className="col-12 col-sm-6 col-lg">
            ...
            <div
              className="p-3 rounded-4 h-100 d-flex gap-3 align-items-center"
              style={{
            ...
            >
              ...
              <div
                className="fs-4 p-2 rounded-3 d-flex align-items-center justify-content-center bg-secondary bg-opacity-10"
              ...
              <div>
                <h6
                  className="fw-semibold text-white mb-0.5"
                  style={{ fontSize: "13px" }}
                >
                  {badge.title}
                </h6>
