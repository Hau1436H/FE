...
import { SiDiscord, SiZalo } from 'react-icons/si';

/**
 * COMPONENT: SocialLinks
 * CHỨC NĂNG CHÍNH:
 * - Quản lý và liên kết các tài khoản mạng xã hội lập trình viên chuyên nghiệp phục vụ tuyển dụng.
 * - Trình bày hệ thống link dẫn ra 5 kênh phổ biến: GitHub, LinkedIn, Portfolio, Zalo và Discord.
 * - Sử dụng các icon chuẩn xác giúp giao diện đồng nhất và dễ nhận diện.
 */
  ...
  return (
    <div className="rounded-4 p-4 mb-2" style={{ backgroundColor: '#131520', border: '1px solid #1e2235' }}>
      ...
      <div className="row g-4">
        ...
        {/* Cột 4: Zalo */}
        <div className="col-12 col-sm-6 col-md-4">
          <label className="text-white-50 extra-small d-block mb-2" style={{ fontSize: '12px', opacity: 0.6 }}>Zalo</label>
          <div className="p-3 rounded-3 text-white d-flex align-items-center gap-3" style={{ backgroundColor: '#0f111a', border: '1px solid #1e2235', fontSize: '13.5px' }}>
            <SiZalo size={15} className="opacity-50" />
            <span>{socials.zalo}</span>
          </div>
        </div>

        {/* Cột 5: Discord */}
        <div className="col-12 col-sm-6 col-md-4">
          <label className="text-white-50 extra-small d-block mb-2" style={{ fontSize: '12px', opacity: 0.6 }}>Discord</label>
          <div className="p-3 rounded-3 text-white d-flex align-items-center gap-3" style={{ backgroundColor: '#0f111a', border: '1px solid #1e2235', fontSize: '13.5px' }}>
            <SiDiscord size={15} className="opacity-50" />
