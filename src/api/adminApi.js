...
export const updateCourse = (id, payload) =>
  axiosClient.put(`/api/courses/${id}`, payload);
...
export const fetchStudentsForAdmin = () =>
  axiosClient.get("/api/v1/admin/students");

// ====== USERS / STAFF (ADMIN) ======
// Hàm gọi API tạo tài khoản Mentor/Counselor
export const createStaffAccount = (staffData) => {
  return axiosClient.post("/api/admin/users/staff", staffData);
};
